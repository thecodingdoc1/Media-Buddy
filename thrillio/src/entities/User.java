...
public class User {
	...
	private UserType userType; // tag field, identifies user as regular user or staff members, violating the use of tag class instead of hierarchy, ok because treating as webapplication, 
